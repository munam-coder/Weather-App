...
//   if (currentUnits.temperature === "imperial") {
//     return (tempCelsius * 9 / 5) + 32; // Convert °C → °F
//   }
//   return tempCelsius; // Keep °C for metric
// }
...
// // ✅ Wrap all code so it only runs *after* the HTML is loaded
...
// // ✅ Update UI after changing units
